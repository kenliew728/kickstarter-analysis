...
1. Include count of outcomes based on the funding goals and total days to reach goal. This will allow us understand if lower funding goals also take lesser day to achieve its target. If the analysis shows that lower funding goals takes longer duration to achieve, launching a campaign with lower funding goals may not be a best option. Here are the example:
